 ...
 * follow into this primed-but-not-descended module to recover the shape (the modular-monorepo layout Eos
 * uses). Proves the refiner's containment gate is PRIME scope, not descend scope.
 */
