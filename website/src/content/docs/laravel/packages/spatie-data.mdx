...
a query builder, [Spatie Query Builder](/laravel/packages/query-builder/) recovers `page` and
`per_page` from the trace; when it happens anywhere else — a helper paginating an in-memory
