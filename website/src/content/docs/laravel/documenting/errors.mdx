...
[`docuccino:diff`](/laravel/reference/commands/#docuccinodiff) reads a `$ref` as the thing it names on
...
API](/laravel/guides/diffing/) has what to expect. In the full document each operation also keeps its
