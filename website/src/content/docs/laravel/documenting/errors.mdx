...
| --- | --- | --- |
| `401` | The route has authentication middleware (matching `security.auto_detect_middleware`). | Mark the route [`#[Unauthenticated]`](/laravel/reference/attributes/) — or `#[IgnoreResponse(401)]`. |
