 ...
 * current node's element. Which container that element belongs to — an array's items or an object's
 * values — is the node's own to settle, not the segment's ({@see FieldNode::build()}). A `file`/`image`
 * transformer raises the multipart flag through the field façade.
 */
