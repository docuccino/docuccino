 ...
 * narrative content tree, overlay files, the lock file the build fingerprint digests, and the
 * engine's own PHPStan config. Those are watched as ROOTS rather than as files, so a route file or a
 * content page that did not exist when the session started still registers as a change.
 *
