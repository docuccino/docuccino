...
final class RuleOrdering
{
    ...
    private const RANK = [
        ...
        // Straight after the type rules, both of them: `additional_properties` REPLACES the `array` one
        // for a recovered map, `date_wire` the `date` one's format for a date-typed property, and the
        // type-aware constraint rules below have to see whatever type they settle on.
        'additional_properties' => 12, 'date_wire' => 12,
        'file' => 15, 'image' => 15,
