...
|---------------------|------------|-------|--------------------------------------------------|
| `core`              | **95.81%** | 95    | fully in-process-measurable                      |
| `laravel`           | **93.49%** | 93    | fully in-process-measurable                      |
| `inference-phpstan` | **40.03%** | 40    | real path is subprocess-only → `fixture`-proven  |
