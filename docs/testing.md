...
|---------------------|------------|-------|--------------------------------------------------|
| `core`              | **95.77%** | 95    | fully in-process-measurable                      |
| `laravel`           | **93.40%** | 93    | fully in-process-measurable                      |
| `inference-phpstan` | **40.19%** | 40    | real path is subprocess-only → `fixture`-proven  |
