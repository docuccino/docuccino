...
const FLOORS = [
    ...
    // phpdoc type grammar, the contract checker. Measured 97.39% (13294/13650) — ratcheted 96 → 97 back
    ...
    // contract-testing assertions. Measured 96.93% (13152/13568) — ratcheted 95 → 96 on the trigger the
    ...
    // tenths of a statement (`laravel` at 96.00%) and at one (this package at 49.05%) — a next-line
